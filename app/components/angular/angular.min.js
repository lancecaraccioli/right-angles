...
(function (N, S, r) {
    ...
    function I(b) {
        return function () {
            var a = arguments[0], c, a = "[" + (b ? b + ":" : "") + a + "] http://errors.angularjs.org/1.3.0-beta.6/" + (b ? b + "/" : "") + a;
    ...
    function cb(b) {
        ...
        var a = b.length;
        return 1 === b.nodeType && a ? !0 : x(b) || M(b) || 0 === a || "number" === typeof a && 0 < a && a - 1 in b
    }
    ...
    function aa(b, a) {
        ...
        if (a) {
            ...
            (a = b) && (M(b) ? a = aa(b, []) : qa(b) ? a = new Date(b.getTime()) : eb(b) ? a = RegExp(b.source) : R(b) && (a = aa(b, {})));
        }
        return a
    }
    ...
    function ya(b, a) {
        ...
        if (c == typeof a && "object" == c) {
            if (M(b)) {
                ...
                for (d in a)if (!c.hasOwnProperty(d) && "$" !== d.charAt(0) && a[d] !== r && !O(a[d])) {
                    return!1;
                }
                return!0
            }
    ...
    function gb(b, a) {
        ...
        return!O(a) || a instanceof RegExp ? a : c.length ? function () {
            return arguments.length ? a.apply(b, c.concat(ra.call(arguments, 0))) : a.apply(b, c)
        } : function () {
    ...
    function gd(b, a) {
        ...
        "string" === typeof b && "$" === b.charAt(0) ? c =
            r : Ca(a) ? c = "$WINDOW" : a && S === a ? c = "$DOCUMENT" : a && (a.$evalAsync && a.$watch) && (c = "$SCOPE");
        return c
    }

    function sa(b, a) {
        return"undefined" === typeof b ? r : JSON.stringify(b, gd, a ? "  " : null)
    }
    ...
    function Pa(b) {
        "function" === typeof b ? b = !0 : b && 0 !== b.length ? (b = u("" + b), b = !("f" == b || "0" == b || "false" == b || "no" == b || "n" == b || "[]" == b)) : b = !1;
        return b
    }
    ...
    function ga(b) {
        ...
        try {
            return 3 === b[0].nodeType ? u(c) : c.match(/^(<[^>]+>)/)[1].replace(/^<([\w\-]+)/,
                function (a, b) {
                    return"<" + u(b)
                })
        } catch (d) {
    ...
    function hd(b, a) {
        var c, d, e = hc.length;
        b = y(b);
        for (d = 0; d < e; ++d)if (c = hc[d] + a, x(c = b.attr(c))) {
            return c;
        }
        return null
    }
    ...
    function id(b, a) {
        ...
        var d = [b], e, f, g = {}, h = ["ng:app", "ng-app", "x-ng-app", "data-ng-app"], m = /\sng[:\-]app(:\s*([\w\d_]+);?)?\s/;
        q(h, function (a) {
            h[a] = !0;
        ...
        e && (g.strictDi = null !== hd(e, "strict-di"), a(e, f ? [f] : [], g))
    }
    ...
    function ic(b, a, c) {
        ...
        var d = function () {
            ...
            a.unshift("ng");
            d = Eb(a, c.strictDi);
            d.invoke(["$rootScope", "$rootElement", "$compile", "$injector", "$animate", function (a, b, c, d, e) {
                a.$apply(function () {
                    b.data("$injector", d);
                    c(b)(a)
                })
    ...
    function Ra(b, a, c) {
        ...
        Fb(O(b), a, "not a function, got " + (b && "object" == typeof b ? b.constructor.name || "Object" : typeof b));
        return b
    }
    ...
    function ld(b) {
        ...
        try {
            ...
            Sa("ngLocale", []).provider("$locale", nd)
        }
        Sa("ng", ["ngLocale"], ["$provide", function (a) {
            a.provider({$$sanitizeUri: od});
            a.provider("$compile", kc).directive({
                ...
                ngValue: Vd,
                ngModelOptions: Wd
            }).directive({ngInclude: Xd}).directive(Hb).directive(nc);
            a.provider({
                $anchorScroll: Yd,
                $animate: Zd,
                $browser: $d,
    ...
    function Ta(b) {
        return b.replace(ve, function (a, b, d, e) {
    ...
    function Ib(b, a, c, d) {
        function e(b) {
            var e = c && b ? [this.filter(b)] :
                [this], m = a, k, l, p, n, t, s;
            if (!d || null != b) {
                for (; e.length;)for (k = e.shift(), l = 0, p = k.length; l < p; l++)for (n = y(k[l]), m ? n.triggerHandler("$destroy") : m = !m, t = 0, n = (s = n.children()).length; t < n; t++)e.push(Ga(s[t]));
            }
            return f.apply(this, arguments)
        }

        var f = Ga.fn[b], f = f.$original || f;
        e.$original = f;
        Ga.fn[b] = e
    }
    ...
    function xe(b, a) {
        ...
        if (Jb.test(b)) {
            ...
            d = (ye.exec(b) || ["", ""])[1].toLowerCase();
            d = da[d] || da._default;
            c.innerHTML = d[1] + b.replace(ze, "<$1></$2>") +
            d[2];
            for (d = d[0]; d--;)c = c.lastChild;
            f = f.concat(ra.call(c.childNodes, void 0));
            c = e.firstChild;
            c.textContent = ""
        } else {
    ...
    function U(b) {
        ...
        if (x(b)) {
            ...
            a = S;
            var c;
            b = (c = Ae.exec(b)) ? [a.createElement(c[1])] : (c = xe(b, a)) ? c.childNodes : []
        }
        pc(this, b)
    }
    ...
    function rc(b, a, c, d) {
        ...
        var e = la(b, "events");
        la(b, "handle") && (A(a) ? q(e, function (a, c) {
            Ua(b, c, a);
            delete e[c]
        }) : q(a.split(" "), function (a) {
            A(c) ? (Ua(b, a, e[a]), delete e[a]) : Ea(e[a] || [], c)
        }))
    }

    function qc(b, a) {
        var c = b[jb], d = Va[c];
        d && (a ? delete Va[c].data[a] : (d.handle && (d.events.$destroy && d.handle({}, "$destroy"), rc(b)), delete Va[c], b[jb] = r))
    }
    ...
    function sc(b, a, c) {
        var d = la(b, "data"), e = F(c), f = !e && F(a), g = f && !R(a);
        d || g || la(b, "data", d = {});
        if (e) {
            d[a] = c;
        } else if (f) {
    ...
    function pc(b, a) {
        if (a) {
            a = a.nodeName || !F(a.length) || Ca(a) ? [a] : a;
    ...
    function mb(b, a, c) {
        ...
        for (a = M(a) ? a : [a]; b.length;) {
            for (var d = b[0], e = 0, f = a.length; e <
            f; e++)if ((c = b.data(a[e])) !== r) {
                return c;
            }
    ...
    function Ia(b) {
        ...
        "object" == a && null !== b ? "function" == typeof(c = b.$$hashKey) ? c =
            b.$$hashKey() : c === r && (c = b.$$hashKey = db()) : c = b;
        return a + ":" + c
    }
    ...
    function Nb(b, a, c) {
        ...
        if ("function" == typeof b) {
            if (!(d = b.$inject)) {
                ...
                if (b.length) {
                    if (a) {
                        throw x(c) && c || (c = b.name || De(b)), Ja("strictdi", c);
                    }
                    a = b.toString().replace(xc, "");
                    a = a.match(yc);
                    q(a[1].split(Ee), function (a) {
                        a.replace(Fe, function (a, b, c) {
                            d.push(c)
                        })
                    })
                }
            ...
            M(b) ? (a = b.length -
            1, Ra(b[a], "fn"), d = b.slice(0, a)) : Ra(b, "fn", !0);
        }
        return d
    }
    ...
    function Eb(b, a) {
        ...
        function f(a) {
            ...
            q(a, function (a) {
                if (!l.get(a)) {
                    ...
                    try {
                        if (x(a)) {
                            for (c = Sa(a), b = b.concat(f(c.requires)).concat(c._runBlocks), d = c._invokeQueue, e = 0, h = d.length; e < h; e++) {
                                var g = d[e], m = n.get(g[0]);
                                m[g[1]].apply(m, g[2])
                            }
                        } else {
                            O(a) ? b.push(n.invoke(a)) : M(a) ? b.push(n.invoke(a)) : Ra(a, "module")
                        }
                    } catch (k) {
                        throw M(a) && (a = a[a.length - 1]), k.message && (k.stack && -1 == k.stack.indexOf(k.message)) && (k = k.message + "\n" + k.stack), Ja("modulerr", a, k.stack || k.message || k);
                    }
                }
            });
            return b
        ...
        function g(b, c) {
            ...
            function e(b, c, f, h) {
                ...
                for (m = h.length; k < m; k++) {
                    ...
                    g.push(f && f.hasOwnProperty(l) ? f[l] : d(l))
                }
                b.$inject || (b = b[m]);
                return b.apply(c, g)
            }
            ...
            return{
                invoke: e, instantiate: function (a, b, c) {
                    ...
                    a = e(a, d, b, c);
                    return R(a) || O(a) ? a : d
                }, get: d, annotate: Nb, has: function (a) {
        ...
        a = !0 === a;
        var h = {}, m = "Provider", k = [], l = new Wa, p = {
            $provide: {
                provider: c(d),
                factory: c(e), service: c(function (a, b) {
        ...
        }, n = p.$injector = g(p, function () {
            throw Ja("unpr", k.join(" <- "));
    ...
    function Ge(b, a, c, d) {
        ...
        function g() {
            v = null;
            z != h.url() && (z = h.url(), q(ma, function (a) {
                a(h.url())
            }))
        }

        var h = this, m = a[0], k = b.location, l = b.history, p = b.setTimeout, n = b.clearTimeout, t = {};
        h.isMock = !1;
        var s = 0, J = [];
        ...
        var z = k.href, W = a.find("base"), v = null;
        h.url = function (a, c) {
            k !== b.location && (k = b.location);
            l !== b.history && (l = b.history);
            if (a) {
                if (z != a) {
                    return z = a, d.history ? c ? l.replaceState(null, "", a) : (l.pushState(null, "", a), W.attr("href", W.attr("href"))) : (v = a, c ? k.replace(a) : k.href =
                        a), h
                }
            } else {
        ...
        var L = {}, Z = "", G = h.baseHref();
        h.cookies = function (a, b) {
            var d, e, f, h;
            if (a) {
                b === r ? m.cookie = escape(a) + "=;path=" + G + ";expires=Thu, 01 Jan 1970 00:00:00 GMT" : x(b) && (d = (m.cookie = escape(a) + "=" + escape(b) +
                ";path=" + G).length + 1, 4096 < d && c.warn("Cookie '" + a + "' possibly not set or overflowed because it was too large (" + d + " > 4096 bytes)!"));
            } else {
                if (m.cookie !== Z) {
                    for (Z = m.cookie, d = Z.split("; "), L = {}, f = 0; f < d.length; f++)e = d[f], h = e.indexOf("="), 0 < h && (a = unescape(e.substring(0, h)), L[a] === r && (L[a] = unescape(e.substring(h + 1))));
                }
                return L
            }
        };
        ...
        h.defer.cancel = function (a) {
            return t[a] ? (delete t[a], n(a), e(D), !0) : !1
        }
    }
    ...
    function ae() {
        this.$get = function () {
            function b(b, d) {
                ...
                var g = 0, h = w({}, d, {id: b}), m = {}, k = d && d.capacity || Number.MAX_VALUE, l = {}, p = null, n = null;
                return a[b] = {
                    put: function (a, b) {
                        ...
                        if (!A(b)) {
                            return a in m || g++, m[a] = b,
                            g > k && this.remove(n.key), b
                        }
                    }, get: function (a) {
                        if (k < Number.MAX_VALUE) {
                            var b = l[a];
    ...
    function kc(b, a) {
        var c = {}, d = "Directive", e = /^\s*directive\:\s*([\d\w\-_]+)\s+(.*)$/, f = /(([\d\w\-_]+)(?:\:([^;]+))?;?)/, g = /^(on[a-z]+|formaction)$/;
        this.directive = function m(a, e) {
            Aa(a, "directive");
            x(a) ? (Fb(e, "directiveFactory"), c.hasOwnProperty(a) || (c[a] = [], b.factory(a + d, ["$injector", "$exceptionHandler", function (b, d) {
                var e = [];
                q(c[a], function (c, f) {
                    try {
                        var g = b.invoke(c);
                        O(g) ? g = {compile: $(g)} : !g.compile && g.link && (g.compile = $(g.link));
        ...
        this.$get = ["$injector", "$interpolate", "$exceptionHandler", "$http", "$templateCache",
            "$parse", "$controller", "$rootScope", "$document", "$sce", "$animate", "$$sanitizeUri", function (a, b, l, p, n, t, s, J, E, B, z, W) {
                ...
                function K(a, b, c, d, e, f) {
                    function g(a, c, d, e) {
                        ...
                        f = c.length;
                        var Xa = Array(f);
                        for (p = 0; p < f; p++)Xa[p] = c[p];
                        E = p = 0;
                        for (n = m.length; p < n; E++)k = Xa[E], c = m[p++], f = m[p++], l = y(k), c ? (c.scope ? (t = a.$new(), l.data("$scope", t)) : t = a, (l = c.transclude) || !e && b ? c(f, t, k, d, L(a, l || b)) : c(f, t, k, d, e)) : f && f(a, k.childNodes, r, e)
                    }

                    for (var m = [], k, l, t, p, n = 0; n < a.length; n++)k = new Ob, l = Z(a[n], [], k, 0 === n ? d : r, e), (f = l.length ? ha(l, a[n], k, b, c, null, [],
                        [], f) : null) && f.scope && ma(y(a[n]), "ng-scope"), k = f && f.terminal || !(t = a[n].childNodes) || !t.length ? null : K(t, f ? f.transclude : b), m.push(f, k), p = p || f || k, f = null;
                    return p ? g : null
                }
                ...
                function Z(a, b, c, d, g) {
                    ...
                    switch (a.nodeType) {
                        case 1:
                            ba(b, na(La(a).toLowerCase()), "E", d, g);
                            var l, t, p;
                            k = a.attributes;
                            for (var n = 0, E = k && k.length; n < E; n++) {
                                var s = !1, B = !1;
                                l = k[n];
                                if (!P ||
                                    8 <= P || l.specified) {
                                    t = l.name;
                                    p = na(t);
                                    Q.test(p) && (t = ib(p.substr(6), "-"));
                                    var J = p.replace(/(Start|End)$/, "");
                                    p === J + "Start" && (s = t, B = t.substr(0, t.length - 5) + "end", t = t.substr(0, t.length - 6));
                                    p = na(t.toLowerCase());
                                    m[p] = t;
                                    c[p] = l = Y(l.value);
                                    vc(a, p) && (c[p] = !0);
                            ...
                            a = a.className;
                            if (x(a) && "" !== a) {
                                for (; k = f.exec(a);)p = na(k[2]), ba(b, p, "C", d, g) && (c[p] = Y(k[3])), a = a.substr(k.index + k[0].length);
                            }
                            break;
                        case 3:
                            u(b, a.nodeValue);
                ...
                function ha(a, c, d, e, f, g, m, p, n) {
                    function E(a, b, c, d) {
                        if (a) {
                            c && (a = C(a, c, d));
                            a.require = H.require;
                            a.directiveName = ca;
                            if (L === H || H.$$isolateScope) {
                                a = zc(a,
                                    {isolateScope: !0});
                            }
                            m.push(a)
                    ...
                    function J(a, e, f, g, n) {
                        ...
                        var z, v, Xa, C, K, G, Z = {}, pb;
                        z = c === f ? d : cc(d, new Ob(y(f), d.$attr));
                        v = z.$$element;
                        if (L) {
                            var ba = /^\s*([@=&])(\??)\s*(\w*)\s*$/;
                            g = y(f);
                            G = e.$new(!0);
                            ha && ha === L.$$originalDirective ? g.data("$isolateScope", G) : g.data("$isolateScopeNoTemplate", G);
                            ma(g, "ng-isolate-scope");
                            q(L.scope, function (a, c) {
                                var d = a.match(ba) || [], f = d[3] || c, g = "?" == d[2], d = d[1], m, l, p, n;
                                G.$$isolateBindings[c] = d + f;
                                switch (d) {
                                    case "@":
                                        z.$observe(f, function (a) {
                                            G[c] = a
                                        });
                                        z.$$observers[f].$$scope = e;
                                        z[f] && (G[c] = b(z[f])(e));
                                        break;
                                    case "=":
                                        if (g && !z[f]) {
                                        ...
                                        p = l.assign || function () {
                                            m = G[c] = l(e);
                                            throw ia("nonassign", z[f], L.name);
                                        };
                                        m = G[c] = l(e);
                                        G.$watch(function () {
                                            var a = l(e);
                                            n(a, G[c]) || (n(a, m) ? p(e, a = G[c]) : G[c] = a);
                                            return m = a
                                        }, null, l.literal);
                                        break;
                                    case "&":
                        ...
                        W && q(W, function (a) {
                            ...
                            c = s(K, b);
                            Z[a.name] = c;
                            w || v.data("$" + a.name + "Controller", c);
                            a.controllerAs && (b.$scope[a.controllerAs] = c)
                        });
                        g = 0;
                        for (Xa = m.length; g < Xa; g++)try {
                            C = m[g], C(C.isolateScope ? G : e, v, z, C.require && B(C.directiveName, C.require, v, Z), pb)
                        } catch (ob) {
                            l(ob, ga(v))
                        }
                        g = e;
                        L && (L.template || null === L.templateUrl) && (g = G);
                        a && a(g, f.childNodes, r, n);
                        for (g = p.length - 1; 0 <= g; g--)try {
                            C = p[g], C(C.isolateScope ? G : e, v, z, C.require && B(C.directiveName, C.require, v, Z), pb)
                        } catch (H) {
                            l(H, ga(v))
                        }
                    }
                    ...
                    n = n || {};
                    for (var z = -Number.MAX_VALUE, K, W = n.controllerDirectives,
                             L = n.newIsolateScopeDirective, ha = n.templateDirective, ba = n.nonTlbTranscludeDirective, qb = !1, w = n.hasElementTranscludeDirective, u = d.$$element = y(c), H, ca, T, I = e, N, ja = 0, P = a.length; ja < P; ja++) {
                        H = a[ja];
                        var Q = H.$$start, V = H.$$end;
                        Q && (u = G(c, Q, V));
                        T = r;
                        if (z > H.priority) {
                            break;
                        ...
                        if (T = H.scope) {
                            K = K || H, H.templateUrl || (A("new/isolated scope", L, H, u), R(T) && (L = H));
                        }
                        ca = H.name;
                        !H.templateUrl && H.controller && (T = H.controller, W = W || {}, A("'" + ca + "' controller", W[ca], H, u), W[ca] = H);
                        if (T = H.transclude) {
                            qb = !0, H.$$tlb || (A("transclusion", ba, H,
                                u), ba = H), "element" == T ? (w = !0, z = H.priority, T = G(c, Q, V), u = d.$$element = y(S.createComment(" " + ca + ": " + d[ca] + " ")), c = u[0], rb(f, y(ra.call(T, 0)), c), I = v(T, e, z, g && g.name, {nonTlbTranscludeDirective: ba})) : (T = y(Lb(c)).contents(), u.empty(), I = v(T, e));
                        }
                        if (H.template) {
                            if (A("template", ha, H, u), ha = H, T = O(H.template) ? H.template(u, d) : H.template, T = U(T), H.replace) {
                                g = H;
                                T = Jb.test(T) ? y(Y(T)) : [];
                                c = T[0];
                                if (1 != T.length || 1 !== c.nodeType) {
                                    throw ia("tplrt", ca, "");
                                }
                                rb(f, u, c);
                                P = {$attr: {}};
                                T = Z(c, [], P);
                                var X = a.splice(ja + 1, a.length - (ja + 1));
                                L && ob(T);
                        ...
                        if (H.templateUrl) {
                            A("template", ha, H, u), ha = H, H.replace && (g = H), J = D(a.splice(ja, a.length - ja), u, d, f, I, m, p, {
                                controllerDirectives: W,
                                newIsolateScopeDirective: L,
                                templateDirective: ha,
                                nonTlbTranscludeDirective: ba
                            }), P = a.length;
                        } else if (H.compile) {
                            try {
                                N = H.compile(u, d, I), O(N) ? E(null, N, Q, V) : N && E(N.pre, N.post, Q, V)
                            } catch (He) {
                                l(He, ga(u))
                            }
                        }
                        H.terminal && (J.terminal = !0, z = Math.max(z, H.priority))
                    }
                    J.scope = K && !0 === K.scope;
                    J.transclude = qb && I;
                ...
                function ba(b, e, f, g, k, p, t) {
                    ...
                    if (c.hasOwnProperty(e)) {
                        var n;
                        e = a.get(e + d);
                        for (var E = 0, s = e.length; E < s; E++)try {
                            n = e[E], (g === r || g > n.priority) && -1 != n.restrict.indexOf(f) && (p && (n = bc(n, {
                                $$start: p,
                                $$end: t
                            })), b.push(n), k = n)
                        } catch (z) {
                ...
                function D(a, b, c, d, e, f, g, k) {
                    var m = [], l, t, E = b[0], s = a.shift(), z = w({}, s, {
                        templateUrl: null,
                        transclude: null,
                        replace: null,
                        $$originalDirective: s
                    }), J = O(s.templateUrl) ? s.templateUrl(b, c) : s.templateUrl;
                    b.empty();
                    p.get(B.getTrustedResourceUrl(J), {cache: n}).success(function (p) {
                        var n,
                            B;
                        p = U(p);
                        if (s.replace) {
                        ...
                        a.unshift(z);
                        l = ha(a, n, c, e, b, s, f, g, k);
                        q(d, function (a, c) {
                            a == n && (d[c] = b[0])
                        });
                        for (t = K(b[0].childNodes, e); m.length;) {
                            p = m.shift();
                            B = m.shift();
                            var C = m.shift(), G = m.shift(), v = b[0];
                            if (B !== E) {
                                var W = B.className;
                                k.hasElementTranscludeDirective && s.replace || (v = Lb(n));
                                rb(C, y(B), v);
                                ma(y(v), W)
                            }
                            B = l.transclude ?
                    ...
                    return function (a, b, c, d, e) {
                        m ? (m.push(b), m.push(c), m.push(d), m.push(e)) : l(t, b, c, d, e)
                    }
                }
                ...
                function A(a, b, c, d) {
                    if (b) {
                        throw ia("multidir", b.name, c.name, a, ga(d));
                    }
                }
                            ...
                            priority: 100, compile: function () {
                                return{
                                    pre: function (c, d, m) {
                                        ...
                                        if (f = b(m[e], !0, I(a, e))) {
                                            m[e] = f(c), (d[e] ||
                                            (d[e] = [])).$$inter = !0, (m.$$observers && m.$$observers[e].$$scope || c).$watch(f, function (a, b) {
                ...
                function rb(a, b, c) {
                    ...
                    if (a) {
                        for (g = 0, m = a.length; g < m; g++)if (a[g] == d) {
                            a[g++] = c;
                            m = g + e - 1;
                    ...
                    d = 1;
                    for (e = b.length; d < e; d++)f = b[d], y(f).remove(), a.appendChild(f),
                        delete b[d];
                    b[0] = c;
                    b.length = 1
                }
                ...
                var ca = b.startSymbol(), ja = b.endSymbol(), U = "{{" == ca || "}}" == ja ? Da : function (a) {
                    return a.replace(/\{\{/g, ca).replace(/}}/g, ja)
                }, Q = /^ngAttr[A-Z]/;
                return v
            }]
    }
    ...
    function na(b) {
        return Ta(b.replace(Ie, ""))
    }

    function Ac(b, a) {
        var c = "", d = b.split(/\s+/), e = a.split(/\s+/), f = 0;
        a:for (; f < d.length; f++) {
            for (var g = d[f], h = 0; h < e.length; h++)if (g == e[h]) {
                continue a;
            }
            c += (0 < c.length ? " " : "") + g
        }
    ...
    function be() {
        ...
        this.$get = ["$injector", "$window", function (c, d) {
            return function (e, f) {
                var g, h, m;
                x(e) && (g = e.match(a), h = g[1], m = g[3], e = b.hasOwnProperty(h) ? b[h] : jc(f.$scope, h, !0) || jc(d, h, !0), Ra(e, h, !0));
                g = c.instantiate(e, f, h);
                if (m) {
                    if (!f || "object" != typeof f.$scope) {
                        throw I("$controller")("noscp", h || e.name, m);
                    }
                    f.$scope[m] = g
                }
                return g
    ...
    function ge() {
        var b = /^\s*(\[|\{[^\{])/, a = /[\}\]]\s*$/, c = /^\)\]\}',?\n/, d = {"Content-Type": "application/json;charset=utf-8"}, e = this.defaults = {
            ...
            headers: {common: {Accept: "application/json, text/plain, */*"}, post: aa(d), put: aa(d), patch: aa(d)},
        ...
        this.$get = ["$httpBackend", "$browser", "$cacheFactory", "$rootScope", "$q", "$injector", function (a, b, c, d, p, n) {
            function t(a) {
                function c(a) {
                    var b =
                        w({}, a, {data: Dc(a.data, a.headers, d.transformResponse)});
                    return 200 <= a.status && 300 > a.status ? b : p.reject(b)
                }
                ...
                var d = {
                    ...
                    var c = e.headers, d = w({}, a.headers), f, g, c = w({}, c.common, c[u(a.method)]);
                    b(c);
                    b(d);
                    a:for (f in c) {
                        a = u(f);
                ...
                (a = Pb(d.url) ?
                    b.cookies()[d.xsrfCookieName || e.xsrfCookieName] : r) && (f[d.xsrfHeaderName || e.xsrfHeaderName] = a);
                var g = [function (a) {
                    f = a.headers;
                    var b = Dc(a.data, Cc(f), a.transformRequest);
                    A(a.data) && q(f, function (a, b) {
            ...
            function s(b, c, f) {
                function g(a, b, c, e) {
                    B && (200 <= a && 300 > a ? B.put(r, [a, b, Bc(c), e]) : B.remove(r));
                    m(b, a, c, e);
                    d.$$phase || d.$apply()
                }
                ...
                function m(a, c, d, e) {
                    c = Math.max(c, 0);
                    (200 <= c && 300 > c ? n.resolve : n.reject)({
                        data: a,
                        status: c,
                        headers: Cc(d),
                        config: b,
                ...
                function k() {
                    var a = fb(t.pendingRequests,
                        b);
                    -1 !== a && t.pendingRequests.splice(a, 1)
                }

                var n = p.defer(), s = n.promise, B, q, r = J(b.url, b.params);
                t.pendingRequests.push(b);
                s.then(k, k);
                (b.cache || e.cache) && (!1 !== b.cache && "GET" == b.method) && (B = R(b.cache) ? b.cache : R(e.cache) ? e.cache : E);
                if (B) {
                    if (q = B.get(r), F(q)) {
                        if (q.then) {
                            return q.then(k, k), q;
                        }
                        M(q) ? m(q[1], q[0], aa(q[2]), q[3]) : m(q, 200, {}, "OK")
                    } else {
                        B.put(r, s);
                    }
                }
                A(q) && a(b.method, r, c, g, f, b.timeout, b.withCredentials, b.responseType);
                return s
            }
            ...
            var E = c("$http"), B = [];
            q(f, function (a) {
                B.unshift(x(a) ? n.get(a) : n.invoke(a))
            });
            q(g, function (a, b) {
                var c = x(a) ? n.get(a) : n.invoke(a);
                B.splice(b, 0, {
                    response: function (a) {
                        return c(p.when(a))
            ...
            (function (a) {
                q(arguments, function (a) {
                    t[a] = function (b, c, d) {
                        return t(w(d || {}, {method: a, url: b, data: c}))
                    }
                })
            })("post", "put");
            t.defaults = e;
    ...
    function Je(b) {
        if (8 >= P && (!b.match(/^(get|post|head|put|delete|options)$/i) || !N.XMLHttpRequest)) {
    ...
    function he() {
        this.$get = ["$browser", "$window", "$document", function (b, a, c) {
            return Ke(b, Je, b.defer, a.angular.callbacks,
                c[0])
        }]
    }
    ...
    function Ke(b, a, c, d, e) {
        ...
        var g = -1;
        return function (e, m, k, l, p, n, t, s) {
            function J() {
                B = g;
                W && W();
                v && v.abort()
            ...
            m = m || b.url();
            if ("jsonp" == u(e)) {
                var z = "_" + (d.counter++).toString(36);
                d[z] = function (a) {
                    d[z].data = a;
                    d[z].called = !0
                };
                var W = f(m.replace("JSON_CALLBACK", "angular.callbacks." + z), z, function (a, b) {
                    E(l, a, d[z].data, "", b);
                    d[z] = D
                })
            } else {
                ...
                v.onreadystatechange = function () {
                    if (v && 4 == v.readyState) {
                        var a =
                            null, b = null;
                        B !== g && (a = v.getAllResponseHeaders(), b = "response"in v ? v.response : v.responseText);
                        E(l, B || v.status, b, a, v.statusText || "")
                    }
                };
    ...
    function ee() {
        ...
        this.$get = ["$parse", "$exceptionHandler", "$sce", function (c, d, e) {
            function f(f, k, l) {
                for (var p,
                         n, t = 0, s = [], J = [], E = [], B = f.length, z = !1, q = !1, v = [], y = {}, K = {}; t < B;)if (-1 != (p = f.indexOf(b, t)) && -1 != (n = f.indexOf(a, p + g))) {
                    t !== p && (q = !0), s.push(f.substring(t, p)), t = f.substring(p + g, n), J.push(t), E.push(c(t)), t = n + h, z = !0;
                } else {
                    t !== B && (q = !0, s.push(f.substring(t)));
                    break
                }
                s.length === J.length && s.push("");
                if (l && z && (q || 1 < J.length)) {
                    throw Ec("noconcat", f);
                }
                if (!k || z) {
                    v.length = s.length + J.length;
                    var L = function (a) {
                        for (var b = 0, c = J.length; b < c; b++)v[2 * b] = s[b], v[2 * b + 1] = a[b];
                        v[2 * c] = s[c];
                        return v.join("")
                    }, Z = function (a) {
                        a = l ? e.getTrusted(l,
                            a) : e.valueOf(a);
                        null === a || A(a) ? a = "" : "string" != typeof a && (a = sa(a));
                        return a
                    };
                    return w(function (a) {
                        var b = a.$id || "notAScope", c = y[b], e = K[b], g = 0, h = J.length, k = Array(h), l, p = e === r ? !0 : !1;
                        c || (c = [], p = !0, a.$on && a.$on("$destroy", function () {
                            y[b] = null;
                            K[b] = null
                        }));
                        try {
                            for (; g < h; g++)l = Z(E[g](a)), l !== c[g] && (p = !0), k[g] = l;
                            p && (y[b] = k, K[b] = e = L(k))
                        } catch (n) {
                            a = Ec("interr", f, n.toString()), d(a)
                        }
                        return e
                    }, {exp: f, separators: s, expressions: J})
                }
            }
    ...
    function fe() {
        this.$get = ["$rootScope", "$window", "$q", function (b, a, c) {
            function d(d, g, h, m) {
                var k = a.setInterval, l = a.clearInterval, p = c.defer(), n = p.promise, t = 0, s = F(m) && !m;
                h = F(h) ? h : 0;
                n.then(null, null, d);
                n.$$intervalId = k(function () {
                    p.notify(t++);
                    0 < h && t >= h && (p.resolve(t), l(n.$$intervalId), delete e[n.$$intervalId]);
                    s || b.$apply()
                }, g);
                e[n.$$intervalId] = p;
                return n
    ...
    function Fc(b, a, c) {
        ...
        a.$$protocol =
            b.protocol;
        a.$$host = b.hostname;
        a.$$port = Q(b.port) || Le[b.protocol] || null
    }
    ...
    function Hc(b, a) {
        ...
        this.$$compose = function () {
            var a = Db(this.$$search), b = this.$$hash ? "#" + hb(this.$$hash) : "";
    ...
    function Tb(b, a) {
        ...
        this.$$compose = function () {
            var c = Db(this.$$search), e = this.$$hash ? "#" + hb(this.$$hash) : "";
    ...
    function ie() {
        ...
        this.$get = ["$rootScope", "$browser", "$sniffer", "$rootElement", function (c, d, e, f) {
            ...
            var h, m, k = d.baseHref(), l = d.url(), p;
            a ? (p = l.substring(0, l.indexOf("/", l.indexOf("//") + 2)) + (k || "/"), m = e.history ? Hc : Ub) : (p = Ya(l), m = Tb);
            h = new m(p, "#" + b);
            h.$$parse(h.$$rewrite(l));
            f.on("click",
                function (a) {
                    if (!a.ctrlKey && !a.metaKey && 2 != a.which) {
                        for (var e = y(a.target); "a" !== u(e[0].nodeName);)if (e[0] === f[0] || !(e = e.parent())[0]) {
                            return;
                        }
                        var g = e.prop("href");
                        R(g) && "[object SVGAnimatedString]" === g.toString() && (g = ta(g.animVal).href);
                        if (m === Ub) {
                            ...
                            if (0 > k.indexOf("://")) {
                                if (g = "#" + b, "/" == k[0]) {
                                    ...
                                    for (var l = h.path().split("/"), k = k.split("/"), n = 0; n < k.length; n++)"." != k[n] && (".." == k[n] ? l.pop() : k[n].length && l.push(k[n]));
                                    g = p + g + l.join("/")
                                }
                            }
                        }
    ...
    function Jc(b, a, c, d, e, f, g) {
        ea(b, f);
        ea(a, f);
        ea(c, f);
        ea(d, f);
        ea(e, f);
        return g.unwrapPromises ? function (g,
                                            m) {
            var k = m && m.hasOwnProperty(b) ? m : g, l;
            if (null == k) {
                return k;
            }
            (k = k[b]) && k.then && (ua(f), "$$v"in k || (l = k, l.$$v = r, l.then(function (a) {
                l.$$v = a
            })), k = k.$$v);
            if (!a) {
                return k;
            ...
            (k = k[a]) && k.then && (ua(f), "$$v"in k || (l = k, l.$$v = r, l.then(function (a) {
                l.$$v = a
            })), k = k.$$v);
            if (!c) {
                return k;
            ...
            (k = k[c]) && k.then && (ua(f), "$$v"in k || (l = k, l.$$v = r, l.then(function (a) {
                l.$$v = a
            })), k = k.$$v);
            if (!d) {
                return k;
            ...
            (k = k[d]) && k.then && (ua(f), "$$v"in k || (l = k, l.$$v = r, l.then(function (a) {
                l.$$v =
                    a
            })), k = k.$$v);
            if (!e) {
            ...
            (k = k[e]) && k.then && (ua(f), "$$v"in k || (l = k, l.$$v = r, l.then(function (a) {
                l.$$v = a
            })), k = k.$$v);
            return k
        } : function (f, g) {
    ...
    function Kc(b, a, c) {
        ...
        if (a.unwrapPromises || 1 !== e) {
            if (a.unwrapPromises || 2 !== e) {
                if (a.csp) {
                    f = 6 > e ? Jc(d[0], d[1], d[2], d[3], d[4], c, a) : function (b, f) {
                        var g = 0, h;
                        do h = Jc(d[g++], d[g++], d[g++], d[g++], d[g++], c, a)(b, f), f = r, b = h; while (g < e);
                        return h
                    };
                } else {
                    var g = "var p;\n";
    ...
    function ke() {
        ...
        this.unwrapPromises =
            function (b) {
                return F(b) ? (a.unwrapPromises = !!b, this) : a.unwrapPromises
            };
        this.logPromiseWarnings = function (b) {
            return F(b) ? (a.logPromiseWarnings = b, this) : a.logPromiseWarnings
        };
        this.$get = ["$filter", "$sniffer", "$log", function (c, d, e) {
            a.csp = d.csp;
            ua = function (b) {
                a.logPromiseWarnings && !Lc.hasOwnProperty(b) && (Lc[b] = !0, e.warn("[$parse] Promise found in the expression `" + b + "`. Automatic unwrapping of promises in Angular expressions is deprecated."))
            };
            return function (d) {
                var e;
                switch (typeof d) {
    ...
    function Oe(b, a) {
        ...
        return{
            defer: e, reject: g, when: function (h, k, l, p) {
                var n = e(), t, s = function (b) {
                    try {
                        return(O(k) ? k : c)(b)
                    } catch (d) {
                        return a(d), g(d)
                ...
                b(function () {
                    f(h).then(function (a) {
                        t || (t = !0, n.resolve(f(a).then(s, J, E)))
                    }, function (a) {
                        t || (t = !0, n.resolve(J(a)))
                    }, function (a) {
                        t || n.notify(E(a))
        ...
        this.$get = ["$injector", "$exceptionHandler", "$parse", "$browser", function (d, e, f, g) {
            ...
            h.prototype = {
                constructor: h, $new: function (a) {
                    ...
                    var e = k(a, "watch"), f = this.$$watchers, g = {fn: b, last: p, get: e, exp: a, eq: !!d};
                    c = null;
                    if (!O(b)) {
                        var h = k(b || D, "listener");
                        g.fn = function (a, b, c) {
                            h(c)
                        }
                    }
                    ...
                    var c = Array(a.length), d = Array(a.length), e = [], f = 0, g = this;
                    q(a, function (a, b) {
                        e.push(g.$watch(a, function (a, e) {
                            d[b] = a;
                            c[b] = e;
                            f++
                        }))
                    }, this);
                    e.push(g.$watch(function () {
                        return f
                    }, function () {
                        b(d, c, g)
                    }));
                    ...
                    var c = this, d, e, g, h = 1 < b.length, k = 0, m = f(a), l = [], n = {}, p = !0, q = 0;
                    return this.$watch(function () {
                        ...
                        if (R(d)) {
                            if (cb(d)) {
                                for (e !== l && (e = l, q = e.length = 0, k++), a = d.length, q !== a && (k++, e.length = q = a), b = 0; b < a; b++)e[b] !== e[b] && d[b] !== d[b] || e[b] === d[b] || (k++, e[b] = d[b]);
                            } else {
                                e !== n && (e = n = {}, q = 0, k++);
                                a = 0;
                        ...
                        if (h) {
                            if (R(d)) {
                                if (cb(d)) {
                                    ...
                                    for (a in g = {}, d)Mc.call(d, a) && (g[a] = d[a]);
                                }
                            } else {
                                g = d
                            }
                    ...
                    var d, f, g, h, k = this.$$asyncQueue, l = this.$$postDigestQueue, q, v, r = b, K, L = [], y, G, C;
                    m("$digest");
                    c = null;
                    do {
                        v = !1;
                        for (K = this; k.length;) {
                            try {
                                C = k.shift(), C.scope.$eval(C.expression)
                            } catch (F) {
                                n.$$phase = null, e(F)
                            }
                            c = null
                        ...
                        a:do {
                            if (h = K.$$watchers) {
                                for (q = h.length; q--;)try {
                                    if (d = h[q]) {
                                        if ((f = d.get(K)) !== (g = d.last) && !(d.eq ? ya(f, g) : "number" == typeof f && "number" == typeof g && isNaN(f) && isNaN(g))) {
                                            v = !0, c = d, d.last =
                                                d.eq ? aa(f) : f, d.fn(f, g === p ? f : g, K), 5 > r && (y = 4 - r, L[y] || (L[y] = []), G = O(d.exp) ? "fn: " + (d.exp.name || d.exp.toString()) : d.exp, G += "; newVal: " + sa(f) + "; oldVal: " + sa(g), L[y].push(G));
                                        } else if (d === c) {
                                            v = !1;
                                            break a
                                        }
                            ...
                            if (!(h = K.$$childHead || K !== this && K.$$nextSibling)) {
                                for (; K !== this && !(h = K.$$nextSibling);)K = K.$parent
                            }
                        } while (K = h);
                        if ((v || k.length) && !r--) {
                            throw n.$$phase = null, a("infdig", b, sa(L));
                        }
                    } while (v || k.length);
                    ...
                    if (!this.$$destroyed) {
                        ...
                        this.$$destroyed = !0;
                        this !== n && (q(this.$$listenerCount, gb(null, l, this)), a.$$childHead == this && (a.$$childHead = this.$$nextSibling), a.$$childTail == this && (a.$$childTail = this.$$prevSibling), this.$$prevSibling && (this.$$prevSibling.$$nextSibling = this.$$nextSibling), this.$$nextSibling && (this.$$nextSibling.$$prevSibling = this.$$prevSibling), this.$parent = this.$$nextSibling = this.$$prevSibling = this.$$childHead = this.$$childTail = this.$root = null, this.$$listeners = {}, this.$$watchers =
                            this.$$asyncQueue = this.$$postDigestQueue = [], this.$destroy = this.$digest = this.$apply = D, this.$on = this.$watch = this.$watchGroup = function () {
                            return D
                        })
                    }
                }, $eval: function (a, b) {
                    ...
                    }, k = [h].concat(ra.call(arguments, 1)), m, l;
                    do {
                        d = f.$$listeners[a] ||
                        c;
                        h.currentScope = f;
                        m = 0;
                        for (l = d.length; m < l; m++)if (d[m]) {
                            try {
                                d[m].apply(null, k)
                            } catch (n) {
                                e(n)
                    ...
                    }, g = [f].concat(ra.call(arguments, 1)), h, k; c = d;) {
                        f.currentScope = c;
                        d = c.$$listeners[a] || [];
                        h = 0;
                        for (k = d.length; h < k; h++)if (d[h]) {
                            try {
                                d[h].apply(null, g)
                            } catch (m) {
                                e(m)
    ...
    function oe() {
        ...
        this.resourceUrlWhitelist = function (a) {
            arguments.length && (b = Nc(a));
            return b
        };
        this.resourceUrlBlacklist =
            function (b) {
                arguments.length && (a = Nc(b));
                return a
            };
            ...
            return{
                trustAs: function (a, b) {
                    ...
                    if (c === fa.RESOURCE_URL) {
                        ...
                        if (n) {
                            for (l =
                                     0, p = a.length; l < p; l++)if ("self" === a[l] ? Pb(f) : a[l].exec(f.href)) {
                                n = !1;
                                break
                            }
                        }
    ...
    function pe() {
        this.$get = ["$window",
            "$document", function (b, a) {
                var c = {}, d = Q((/android (\d+)/.exec(u((b.navigator || {}).userAgent)) || [])[1]), e = /Boxee/i.test((b.navigator || {}).userAgent), f = a[0] || {}, g = f.documentMode, h, m = /^(Moz|webkit|O|ms)(?=[A-Z])/, k = f.body && f.body.style, l = !1, p = !1;
                if (k) {
                    for (var n in k)if (l = m.exec(n)) {
                        h = l[0];
                    ...
                    p = !!("animation"in k || h + "Animation"in k);
                    !d || l && p || (l = x(f.body.style.webkitTransition),
                        p = x(f.body.style.webkitAnimation))
                }
                return{
    ...
    function re() {
        this.$get = ["$rootScope", "$browser", "$q", "$exceptionHandler", function (b, a, c, d) {
            function e(e, h, m) {
                var k = c.defer(), l = k.promise, p = F(m) && !m;
                h = a.defer(function () {
                    try {
                        k.resolve(e())
                    } catch (a) {
    ...
    function Pb(b) {
        b = x(b) ? ta(b) : b;
        return b.protocol === Oc.protocol && b.host === Oc.host
    }
    ...
    function Qe() {
        return function (b, a, c) {
            ...
            var d = typeof c, e = [];
            e.check = function (a) {
                for (var b = 0; b < e.length; b++)if (!e[b](a)) {
                    return!1;
                }
                return!0
            };
            "function" !== d && (c = "boolean" === d && c ? function (a, b) {
                ...
                if (a && b && "object" === typeof a && "object" === typeof b) {
                    for (var d in a)if ("$" !== d.charAt(0) && Mc.call(a, d) && c(a[d], b[d])) {
                        return!0;
                    }
                    return!1
                }
                    ...
                    case "object":
                        switch (typeof b) {
                            case "object":
                                return c(a, b);
                            default:
                                for (var d in a)if ("$" !== d.charAt(0) && f(a[d], b)) {
                                    return!0
                                }
                        }
                        return!1;
                    case "array":
                        for (d = 0; d < a.length; d++)if (f(a[d], b)) {
                            return!0;
                        }
                        return!1;
                    default:
    ...
    function Pc(b) {
        ...
        return function (b, d) {
            ...
            return Tc(b, a.PATTERNS[1], a.GROUP_SEP, a.DECIMAL_SEP, 2).replace(/\u00A4/g, d)
        }
    }
    ...
    function Rc(b) {
        var a = b.NUMBER_FORMATS;
        return function (b, d) {
            return Tc(b, a.PATTERNS[0], a.GROUP_SEP, a.DECIMAL_SEP, d)
        }
    }
    ...
    function Tc(b, a, c, d, e) {
        ...
        if (k) {
            ...
            if (g.length >= p + n) {
                for (l = g.length - p, k = 0; k < l; k++)0 === (l - k) % n && 0 !== k && (h += c), h += g.charAt(k);
            }
            for (k = l; k < g.length; k++)0 ===
            (g.length - k) % p && 0 !== k && (h += c), h += g.charAt(k);
            for (; b.length < e;)b += "0";
    ...
    function wb(b, a) {
        return function (c, d) {
            var e = c["get" + b](), f = Fa(a ? "SHORT" + b : b);
            return d[f][e]
        }
    }
    ...
    function Qc(b) {
        ...
        return function (c, e) {
            ...
            x(c) && (c = Ve.test(c) ? Q(c) : a(c));
            Cb(c) && (c = new Date(c));
            if (!qa(c)) {
                return c;
            }
            for (; e;)(m = We.exec(e)) ? (g = g.concat(ra.call(m, 1)), e = g.pop()) : (g.push(e), e = null);
            q(g, function (a) {
                h = Xe[a];
                f += h ? h(c, b.DATETIME_FORMATS) : a.replace(/(^'|'$)/g,
                    "").replace(/''/g, "'")
            });
            return f
        }
    ...
    function Se() {
        return function (b, a) {
            ...
            a = Infinity === Math.abs(Number(a)) ? Number(a) : Q(a);
            if (x(b)) {
    ...
    function Xc(b, a, c, d) {
        ...
        var f = this, g = b.parent().controller("form") || zb, h = 0, m = f.$error = {}, k = [];
        ...
        f.$setValidity = function (a, b, c) {
            var d = m[a];
            if (b) {
                d && (Ea(d, c), d.length || (h--, h || (e(b), f.$valid = !0, f.$invalid = !1), m[a] = !1, e(!0, a), g.$setValidity(a, !0, f)));
            } else {
                h || e(b);
                if (d) {
                    if (-1 != fb(d, c)) {
    ...
    function ab(b, a, c, d, e, f) {
        var g = a.prop("validity"), h = a[0].placeholder, m = {};
        if (!e.android) {
            var k = !1;
        ...
        var l = function (e) {
            if (!k) {
                var f = a.val(), n = e && e.type;
                if (P && "input" === (e || m).type && a[0].placeholder !== h) {
                    h = a[0].placeholder;
                } else if (Pa(c.ngTrim || "T") && (f = Y(f)), d.$viewValue !== f || g && "" === f && !g.valueMissing) {
                    b.$$phase ? d.$setViewValue(f, n) : b.$apply(function () {
                        d.$setViewValue(f, n)
                    })
                }
            }
        };
        if (d.$options && d.$options.updateOn) {
            a.on(d.$options.updateOn, l);
        }
        if (!d.$options || d.$options.updateOnDefault) {
            if (e.hasEvent("input")) {
                a.on("input", l);
            } else {
                var p, n = function (a) {
        ...
        q && ((e = q.match(/^\/(.*)\/([gim]*)$/)) ? (q = RegExp(e[1], e[2]), e = function (a) {
            return pa(d, "pattern", d.$isEmpty(a) || q.test(a), a)
        }) : e = function (c) {
            var e = b.$eval(q);
            if (!e || !e.test) {
                throw I("ngPattern")("noregexp", q, e, ga(a));
            }
            return pa(d, "pattern", d.$isEmpty(c) || e.test(c),
                c)
        }, d.$formatters.push(e), d.$parsers.push(e));
        if (c.ngMinlength) {
            var s = Q(c.ngMinlength);
            e = function (a) {
                return pa(d, "minlength", d.$isEmpty(a) || a.length >= s, a)
            };
            d.$parsers.push(e);
            d.$formatters.push(e)
        }
        if (c.ngMaxlength) {
            var J = Q(c.ngMaxlength);
            e = function (a) {
                return pa(d, "maxlength", d.$isEmpty(a) || a.length <= J, a)
            };
            d.$parsers.push(e);
            d.$formatters.push(e)
        }
    ...
    function Bb(b, a) {
        return function (c) {
            var d;
            return qa(c) ? c : x(c) && (b.lastIndex = 0, c = b.exec(c)) ? (c.shift(), d = {
                yyyy: 0,
                MM: 1,
                dd: 1,
                HH: 0,
    ...
    function Xb(b, a) {
        ...
        return["$animate", function (c) {
            function d(a, b) {
                var c = [], d = 0;
                a:for (; d < a.length; d++) {
                    for (var e = a[d], l = 0; l < b.length; l++)if (e == b[l]) {
                        continue a;
                    }
                    c.push(e)
                }
                    ...
                    function k(b) {
                        if (!0 === a || f.$index % 2 === a) {
                            ...
                            if (!l) {
                                ...
                                var s = e(l), q = d(k, s), k = d(s, k), k = m(k, -1), q = m(q, 1);
                                0 === q.length ? c.removeClass(g, k) : 0 === k.length ? c.addClass(g, q) : c.setClass(g, q, k)
                            }
                        }
                        l = aa(b)
                    }
    ...
    }, Mc = Object.prototype.hasOwnProperty, Fa = function (b) {
        return x(b) ? b.toUpperCase() : b
    }, P, y, Ga, ra = [].slice, Ze = [].push, xa = Object.prototype.toString, Oa = I("ng"), Qa = N.angular || (N.angular = {}), Sa, La, ka = ["0", "0", "0"];
    P = Q((/msie (\d+)/.exec(u(navigator.userAgent)) || [])[1]);
    isNaN(P) && (P = Q((/trident\/.*; rv:(\d+)/.exec(u(navigator.userAgent)) ||
    [])[1]));
    D.$inject = [];
    Da.$inject = [];
    var Y = function () {
    ...
    var hc = ["ng-", "data-ng-", "ng:", "x-ng-"], jd = /[A-Z]/g, md = {
            full: "1.3.0-beta.6",
            major: 1,
            minor: 3,
            dot: 0,
        ...
        Va = U.cache = {}, jb = U.expando = "ng-" + (new Date).getTime(), Be = 1, sb = N.document.addEventListener ? function (b, a, c) {
            b.addEventListener(a, c, !1)
        } : function (b, a, c) {
            b.attachEvent("on" + a, c)
        }, Ua = N.document.removeEventListener ? function (b, a, c) {
    ...
    var ve = /([\:\-\_]+(.))/g, we = /^moz([A-Z])/, Kb = I("jqLite"), Ae = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, Jb = /<|&#?\w+;/, ye = /<([\w:]+)/, ze = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi,
        da = {
    ...
    var Ka = U.prototype = {
        ready: function (b) {
            ...
            var c = !1;
            "complete" === S.readyState ? setTimeout(a) : (this.on("DOMContentLoaded", a), U(N).on("load", a))
        },
        toString: function () {
            var b = [];
            q(this, function (a) {
        ...
        }, length: 0, push: Ze, sort: [].sort, splice: [].splice
    }, nb = {};
    ...
    q({
        data: sc, inheritedData: mb, scope: function (b) {
            return y(b).data("$scope") || mb(b.parentNode || b, ["$isolateScope",
                "$scope"])
            ...
            b.removeAttribute(a)
        }, hasClass: Mb, css: function (b, a, c) {
            a = Ta(a);
            if (F(c)) {
                b.style[a] = c;
            } else {
            ...
            if (nb[d]) {
                if (F(c)) {
                    ...
                    return b[a] || (b.attributes.getNamedItem(a) || D).specified ? d : r;
                }
            } else if (F(c)) {
                b.setAttribute(a, c);
        ...
        U.prototype[a] = function (a, d) {
            var e, f;
            if (b !== uc && (2 == b.length && b !== Mb && b !== tc ? a : d) === r) {
                if (R(a)) {
                    for (e = 0; e < this.length; e++)if (b === sc) {
                        b(this[e], a);
                    } else {
                ...
                e = b.$dv;
                f = e === r ? Math.min(this.length, 1) : this.length;
                for (var g = 0; g < f; g++) {
                    var h = b(this[g], a, d);
                    e =
                        e ? e + h : h
    ...
    q({
        removeData: qc, dealoc: Ha, on: function a(c, d, e, f) {
            if (F(f)) {
                throw Kb("onargs");
            }
            var g = la(c, "events"), h = la(c, "handle");
            g || la(c, "events", g = {});
            h || la(c, "handle", h = Ce(c, g));
            ...
            d = d || [];
            var e = [
                {preventDefault: D, stopPropagation: D}
            ];
            q(c, function (c) {
        ...
        U.prototype[c] = function (c, e, f) {
            for (var g, h = 0; h < this.length; h++)A(g) ? (g = a(this[h], c, e, f), F(g) && (g = y(g))) : pc(g, a(this[h], c, e, f));
            return F(g) ? g : this
        };
    ...
    var yc = /^function\s*[^\(]*\(\s*([^\)]*)\)/m, Ee = /,/, Fe = /^\s*(_?)(\S+?)\1\s*$/, xc = /((\/\/.*$)|(\/\*[\s\S]*?\*\/))/mg, Ja = I("$injector");
    Eb.$$annotate = Nb;
    var $e = I("$animate"), Zd = ["$provide", function (a) {
        this.$$selectors = {};
    ...
    var Ie = /^(x[\:\-_]|data[\:\-_])/i, Ec = I("$interpolate"), af = /^([^\?#]*)(\?([^#]*))?(#(.*))?$/, Le = {
        http: 80,
        https: 443,
        ftp: 21
    }, Sb = I("$location");
    Ub.prototype = Tb.prototype = Hc.prototype = {
        $$html5: !1, $$replace: !1, absUrl: tb("$$absUrl"), url: function (a, c) {
            if (A(a)) {
                return this.$$url;
            }
            var d = af.exec(a);
        ...
        host: tb("$$host"), port: tb("$$port"), path: Ic("$$path", function (a) {
            ...
            this.$$compose();
            return this
        }, hash: Ic("$$hash", Da), replace: function () {
            this.$$replace = !0;
            return this
        }
    };
    var Ba = I("$parse"), Lc = {}, ua, Na = {
            "null": function () {
                return null
            }, "true": function () {
                return!0
    ...
    Wb.prototype = {
        constructor: Wb, lex: function (a) {
            ...
            for (a = []; this.index < this.text.length;) {
                ...
                if (this.is("\"'")) {
                    ...
                    var d = this.ch + this.peek(), e = d + this.peek(2), f = Na[this.ch], g = Na[d], h = Na[e];
                    h ? (this.tokens.push({
                        index: this.index,
                        text: e,
                        fn: h
            ...
            if (Na.hasOwnProperty(c)) {
                d.fn = Na[c], d.json = Na[c];
            } else {
                var m = Kc(c, this.options, this.text);
                d.fn = w(function (a, c) {
                    return m(a, c)
                }, {
                    assign: function (d, e) {
        ...
        readString: function (a) {
            ...
            for (var d = "", e = a, f = !1; this.index < this.text.length;) {
                ...
                if (f) {
                    "u" === g ? (g = this.text.substring(this.index + 1, this.index + 5), g.match(/[\da-f]{4}/i) || this.throwError("Invalid unicode escape [\\u" + g + "]"), this.index += 4, d += String.fromCharCode(parseInt(g, 16))) : d = (f = bf[g]) ? d + f : d + g, f = !1;
                } else if ("\\" === g) {
                    f = !0;
                } else {
                    if (g === a) {
    ...
    $a.prototype = {
        constructor: $a, parse: function (a, c) {
            ...
            for (var d; c = this.expect("(", "[", ".");)"(" === c.text ? (a = this.functionCall(a, d), d = null) : "[" === c.text ?
        ...
        statements: function () {
            ...
            for (var a = this.expression(), c; ;)if (c = this.expect("|")) {
            ...
            for (var a = this.logicalAND(), c; ;)if (c = this.expect("||")) {
        ...
        relational: function () {
            ...
            var a;
            return this.expect("+") ? this.primary() : (a = this.expect("-")) ? this.binaryFn($a.ZERO, a.fn,
                this.unary()) : (a = this.expect("!")) ? this.unaryFn(a.fn, this.unary()) : this.primary()
        }, fieldAccess: function (a) {
            var c = this, d = this.expect().text, e = Kc(d, this.options, this.text);
            return w(function (c, d, h) {
                return e(h || a(c, d))
            }, {
                assign: function (e, g, h) {
                    return ub(a(e, h), d, g, c.text, c.options)
                }
            })
            ...
            return w(function (e, f) {
                ...
                (g = Za(g[h], c.text)) && (g.then && c.options.unwrapPromises) && (m = g, "$$v"in g || (m.$$v = r, m.then(function (a) {
                    m.$$v =
                        a
                })), g = g.$$v);
                return g
    ...
    var Vb = {}, va = I("$sce"), fa = {
        ...
        JS: "js"
    }, V = S.createElement("a"), Oc = ta(N.location.href, !0);
    oc.$inject = ["$provide"];
    Pc.$inject = ["$locale"];
    Rc.$inject = ["$locale"];
    var Uc = ".", Xe = {
        ...
        ww: Wc(2),
        w: Wc(1)
    }, We = /((?:[^yMdHhmsaZEw']+)|(?:'(?:[^']|'')*')|(?:E+|y+|M+|d+|H+|h+|m+|s+|a|Z|w+))(.*)/, Ve = /^\-?\d+$/;
    Qc.$inject = ["$locale"];
    var Te =
        $(u), Ue = $(Fa);
    Sc.$inject = ["$parse"];
    var pd = $({
        restrict: "E", compile: function (a, c) {
            8 >= P && (c.href || c.name || c.$set("href", ""), a.append(S.createComment("IE fix")));
        ...
        Hb[c] = function () {
            return{
                priority: 99, link: function (d, e, f) {
                    var g = a, h = a;
                    "href" === a && "[object SVGAnimatedString]" === xa.call(e.prop("href")) && (h = "xlinkHref", f.$attr[h] = "xlink:href", g = null);
    ...
    var zb = {$addControl: D, $removeControl: D, $setValidity: D, $setDirty: D, $setPristine: D};
    Xc.$inject = ["$element", "$attrs", "$scope", "$animate"];
    var Yc = function (a) {
            return["$timeout", function (c) {
                return{
                    name: "form",
                    restrict: a ? "EAC" : "E", controller: Xc, compile: function () {
                        return{
        ...
        }, qd = Yc(), Dd = Yc(!0), cf = /^(ftp|http|https):\/\/(\w+:{0,1}\w*@)?(\S+)(:[0-9]+)?(\/|\/([\w#!:.?+=&%@!\-\/]))?$/,
        df = /^[a-z0-9!#$%&'*+/=?^_`{|}~.-]+@[a-z0-9-]+(\.[a-z0-9-]+)*$/i, ef = /^\s*(\-|\+)?(\d+|(\d*(\.\d*)))\s*$/, Zc = /^(\d{4})-(\d{2})-(\d{2})$/, $c = /^(\d{4})-(\d\d)-(\d\d)T(\d\d):(\d\d)$/, Yb = /^(\d{4})-W(\d\d)$/, ad = /^(\d{4})-(\d\d)$/, bd = /^(\d\d):(\d\d)$/, ff = /(\b|^)default(\b|$)/, cd = {
            text: ab,
            date: bb("date", Zc, Bb(Zc, ["yyyy", "MM", "dd"]), "yyyy-MM-dd"),
            "datetime-local": bb("datetimelocal", $c, Bb($c, ["yyyy", "MM", "dd", "HH", "mm"]), "yyyy-MM-ddTHH:mm"),
            time: bb("time", bd, Bb(bd, ["HH", "mm"]), "HH:mm"),
            week: bb("week", Yb, function (a) {
                if (qa(a)) {
                    return a;
                }
                if (x(a)) {
                    ...
                    if (c) {
                        a = +c[1];
                        var d = +c[2], c = Vc(a), d = 7 * (d - 1);
                        return new Date(a, 0, c.getDate() + d)
                    }
                }
                return NaN
            }, "yyyy-Www"),
            month: bb("month", ad, Bb(ad, ["yyyy", "MM"]), "yyyy-MM"),
            number: function (a, c, d, e, f, g) {
                ...
                e.$formatters.push(function (a) {
                    return pa(e, "number", e.$isEmpty(a) || Cb(a), a)
                })
            },
            url: function (a, c, d, e, f, g) {
                ab(a, c, d, e, f, g);
                a = function (a) {
                    return pa(e, "url", e.$isEmpty(a) || cf.test(a), a)
                };
                e.$formatters.push(a);
                e.$parsers.push(a)
            },
            email: function (a, c, d, e, f, g) {
                ab(a, c, d, e, f, g);
                a = function (a) {
                    return pa(e, "email", e.$isEmpty(a) || df.test(a), a)
                };
                e.$formatters.push(a);
                e.$parsers.push(a)
            },
            radio: function (a, c, d, e) {
                A(d.name) && c.attr("name", db());
                var f = function (f) {
                    c[0].checked && a.$apply(function () {
                        e.$setViewValue(d.value, f && f.type)
                    })
                };
                if (e.$options && e.$options.updateOn) {
                    c.on(e.$options.updateOn, f);
                }
                if (!e.$options || e.$options.updateOnDefault) {
                    c.on("click", f);
                }
                e.$render = function () {
            ...
            reset: D,
            file: D
        }, lc = ["$browser", "$sniffer", "$filter", function (a,
                                                              c, d) {
            return{
                restrict: "E", require: ["?ngModel"], link: function (e, f, g, h) {
                    h[0] && (cd[u(g.type)] || cd.text)(e, f, g, h[0], c, a, d)
                }
            }
        }], yb = "ng-valid", xb = "ng-invalid", Ma = "ng-pristine", Ab = "ng-dirty", gf = ["$scope", "$exceptionHandler", "$attrs", "$element", "$parse", "$animate", "$timeout", function (a, c, d, e, f, g, h) {
            function m(a, c) {
                c = c ? "-" + ib(c, "-") : "";
            ...
            this.$invalid = !1;
            this.$name = d.name;
            var k = f(d.ngModel), l = k.assign, p = null, n = this;
            if (!l) {
                throw I("ngModel")("nonassign", d.ngModel, ga(e));
            }
            this.$render = D;
            this.$isEmpty = function (a) {
                return A(a) || "" === a || null === a || a !== a
            };
            var t = e.inheritedData("$formController") || zb, s = 0, r = this.$error = {};
            e.addClass(Ma);
            m(!0);
            this.$setValidity = function (a, c) {
                r[a] !== !c && (c ? (r[a] && s--, s || (m(!0), n.$valid = !0, n.$invalid = !1)) : (m(!1), n.$invalid = !0, n.$valid = !1, s++), r[a] = !c, m(c, a), t.$setValidity(a, c, n))
            };
            ...
            this.$$realSetViewValue = function (d) {
                n.$viewValue = d;
                n.$pristine && (n.$dirty = !0, n.$pristine = !1, g.removeClass(e, Ma), g.addClass(e, Ab), t.$setDirty());
                q(n.$parsers, function (a) {
                    d = a(d)
                });
                n.$modelValue !== d && (n.$modelValue = d, l(a, d), q(n.$viewChangeListeners, function (a) {
                    try {
                        a()
                    } catch (d) {
                        c(d)
            ...
            this.$setViewValue = function (a, c) {
                var d = n.$options && (R(n.$options.debounce) ?
                    n.$options.debounce[c] || n.$options.debounce["default"] || 0 : n.$options.debounce) || 0;
                h.cancel(p);
                d ? p = h(function () {
                    n.$$realSetViewValue(a)
                }, d) : n.$$realSetViewValue(a)
            };
            a.$watch(function () {
                var c = k(a);
                if (n.$modelValue !== c) {
                    ...
                    n.$viewValue !== c && (n.$viewValue = c, n.$render())
                }
                return c
            })
        }], Sd = function () {
            return{
                require: ["ngModel", "^?form", "^?ngModelOptions"], controller: gf, link: function (a, c, d, e) {
                    var f = e[0], g = e[1] || zb;
                    g.$addControl(f);
                    e[2] && (f.$options =
                        e[2].$options);
            ...
            return{
                controller: ["$scope", "$attrs", function (a, c) {
                    ...
                    this.$options.updateOn ? (this.$options.updateOnDefault = !1, this.$options.updateOn = this.$options.updateOn.replace(ff, function () {
                        d.$options.updateOnDefault = !0;
                        return" "
                    })) : this.$options.updateOnDefault = !0
                }]
            }
        }, vd = wa(function (a, c, d) {
        ...
        }], yd = Xb("", !0), Ad = Xb("Odd", 0), zd = Xb("Even", 1), Bd = wa({
    ...
    var Fd = ["$animate", function (a) {
        return{
            transclude: "element", priority: 600, terminal: !0, restrict: "A", $$tlb: !0, link: function (c,
                ...
                c.$watch(e.ngIf, function (f) {
                    ...
                    })) : (k && (k.remove(), k = null), m && (m.$destroy(), m = null), h && (k = Gb(h.clone), a.leave(k, function () {
                        k = null
                    }), h = null))
                })
            }
        }
    }], Gd = ["$http", "$templateCache", "$anchorScroll", "$animate", "$sce", function (a, c, d, e, f) {
        return{
            restrict: "ECA",
            priority: 400,
            terminal: !0,
            ...
            compile: function (g, h) {
                var m = h.ngInclude ||
                    h.src, k = h.onload || "", l = h.autoscroll;
                return function (g, h, q, s, r) {
                    var E = 0, B, z, y, v = function () {
                        z && (z.remove(), z = null);
                        B && (B.$destroy(), B = null);
                        y && (e.leave(y, function () {
                            z = null
                        }), z = y, y = null)
                    };
    ...
    }), Id = wa({terminal: !0, priority: 1E3}), Jd = ["$locale", "$interpolate", function (a, c) {
        var d = /{}/g;
        return{
            restrict: "EA", link: function (e, f, g) {
                var h = g.count, m = g.$attr.when && f.attr(g.$attr.when), k = g.offset || 0, l = e.$eval(m) || {}, p = {}, n = c.startSymbol(),
                    t = c.endSymbol(), s = /^when(Minus)?(.+)$/;
                q(g, function (a, c) {
                    s.test(c) && (l[u(c.replace("when", "").replace("Minus", "-"))] = f.attr(g.$attr[c]))
                });
                q(l, function (a, e) {
                    p[e] = c(a.replace(d, n + h + "-" + k + t))
                });
                e.$watch(function () {
    ...
    }], Kd = ["$parse", "$animate", function (a, c) {
        var d = I("ngRepeat");
        return{
            transclude: "element", priority: 1E3, terminal: !0, $$tlb: !0, link: function (e, f, g, h, m) {
                var k = g.ngRepeat, l = k.match(/^\s*([\s\S]+?)\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?\s*$/),
                    p, n, t, s, r, E, B = {$id: Ia};
                if (!l) {
                    throw d("iexp", k);
                }
                ...
                e.$watchCollection(h, function (a) {
                    var g, h, l = f[0], p, B = {}, F, C, u, x, D, w, A = [];
                    if (cb(a)) {
                        D = a, p = n || t;
                    } else {
                        p = n || s;
                        D = [];
                        for (u in a)a.hasOwnProperty(u) && "$" != u.charAt(0) && D.push(u);
                        D.sort()
                    }
                    F = D.length;
                    h = A.length = D.length;
                    for (g = 0; g < h; g++)if (u = a === D ? g : D[g], x = a[u], x = p(u, x, g), Aa(x, "`track by` id"), z.hasOwnProperty(x)) {
                        w = z[x], delete z[x], B[x] = w, A[g] = w;
                    } else {
                    ...
                    for (u in z)z.hasOwnProperty(u) && (w = z[u], g = Gb(w.clone), c.leave(g), q(g, function (a) {
                        a.$$NG_REMOVED = !0
                    }), w.scope.$destroy());
                    g = 0;
                    for (h = D.length; g < h; g++) {
                        ...
                        x = a[u];
                        w = A[g];
                        A[g - 1] && (l = A[g - 1].clone[A[g - 1].clone.length - 1]);
                        if (w.scope) {
                            C = w.scope;
                            p = l;
                            do p = p.nextSibling; while (p && p.$$NG_REMOVED);
                            w.clone[0] != p && c.move(Gb(w.clone), null, y(l));
                        ...
                        C.$odd = !(C.$even = 0 === (g & 1));
                        w.scope || m(C, function (a) {
                            a[a.length++] = S.createComment(" end ngRepeat: " + k + " ");
                            c.enter(a, null, y(l));
                            l = a;
                            w.scope = C;
                            w.clone = a;
        ...
        link: function (a, c, d, e, f) {
            if (!f) {
                throw I("ngTransclude")("orphan", ga(c));
            }
            f(function (a) {
                c.empty();
                c.append(a)
    ...
    }], jf = I("ngOptions"), Qd = $({terminal: !0}), sd = ["$compile", "$parse", function (a,
                                                                                           c) {
        var d = /^\s*([\s\S]+?)(?:\s+as\s+([\s\S]+?))?(?:\s+group\s+by\s+([\s\S]+?))?\s+for\s+(?:([\$\w][\$\w]*)|(?:\(\s*([\$\w][\$\w]*)\s*,\s*([\$\w][\$\w]*)\s*\)))\s+in\s+([\s\S]+?)(?:\s+track\s+by\s+([\s\S]+?))?$/, e = {$setViewValue: D};
        return{
            restrict: "E",
            ...
            controller: ["$element", "$scope", "$attrs", function (a, c, d) {
                ...
                m.addOption = function (c) {
                    Aa(c, '"option value"');
                    k[c] = !0;
                    l.$viewValue == c && (a.val(c), p.parent() &&
                    p.remove())
                };
            ...
            link: function (e, g, h, m) {
                function k(a, c, d, e) {
                    d.$render = function () {
                        var a = d.$viewValue;
                        e.hasOption(a) ? (w.parent() && w.remove(), c.val(a), "" === a && x.prop("selected", !0)) : A(a) &&
                        x ? c.val("") : e.renderUnknownOption(a)
                    };
                ...
                function l(a, c, d) {
                    ...
                    a.$watch(function () {
                        ya(e, d.$viewValue) || (e = aa(d.$viewValue), d.$render())
                    });
                    c.on("change", function () {
                        a.$apply(function () {
                            var a = [];
                ...
                function p(e, f, g) {
                    function h() {
                        ...
                        s = g.$modelValue;
                        w = y(e) || [];
                        var D = n ? Zb(w) : w, E, A, C;
                        A = {};
                        r = !1;
                        var G, I;
                        if (t) {
                            if (v && M(s)) {
                                for (r = new Wa([]), C = 0; C < s.length; C++)A[m] = s[C], r.put(v(e, A), s[C]);
                            } else {
                                r = new Wa(s);
                            }
                        }
                        for (C = 0; E = D.length, C < E; C++) {
                            ...
                            t ? d = F(r.remove(v ? v(e, A) : q(e, A))) : (v ? (d = {}, d[m] = s, d = v(e, d) === v(e, A)) : d = s === q(e, A), r = r || d);
                            G = l(e, A);
                            G = F(G) ? G : "";
                            k.push({id: v ? v(e, A) : n ? D[C] : C, label: G, selected: d})
                        }
                        t || (u || null ===
                        s ? a[""].unshift({id: "", label: "", selected: !r}) : r || a[""].unshift({
                            id: "?",
                            label: "",
                            selected: !0
                        }));
                        ...
                        for (D = c.length; A < D; A++) {
                            ...
                            x.length <= A ? (s = {
                                ...
                                label: k.label
                            }, w = [s], x.push(w), f.append(s.element)) : (w = x[A], s = w[0], s.label != d && s.element.attr("label", s.label = d));
                            G = null;
                            C = 0;
                            for (E = k.length; C < E; C++)r = k[C], (d = w[C + 1]) ? (G = d.element, d.label !== r.label && G.text(d.label = r.label), d.id !== r.id && G.val(d.id = r.id), d.selected !== r.selected && G.prop("selected", d.selected = r.selected)) :
                                ("" === r.id && u ? I = u : (I = B.clone()).val(r.id).attr("selected", r.selected).text(r.label), w.push({
                                    element: I,
                                    label: r.label,
                                    id: r.id,
                                    selected: r.selected
                                }), G ? G.after(I) : s.element.append(I), G = I);
                            for (C++; w.length > C;)w.pop().element.remove()
                        }
                        for (; x.length > A;)x.pop()[0].element.remove()
                    }

                    var k;
                    if (!(k = s.match(d))) {
                        throw jf("iexp", s, ga(f));
                    }
                    var l = c(k[2] || k[1]), m = k[4] || k[6], n = k[5], p = c(k[3] || ""), q = c(k[2] ? k[1] : m), y = c(k[7]), v = k[8] ? c(k[8]) : null, x = [
                        [
                            {element: f, label: ""}
                        ]
                    ];
                    ...
                    f.on("change", function () {
                        e.$apply(function () {
                            var a, c = y(e) || [], d = {}, h, k, l, p, s, w, u;
                            if (t) {
                                for (k = [], p = 0, w = x.length; p < w; p++)for (a = x[p], l = 1, s = a.length; l < s; l++) {
                                    if ((h = a[l].element)[0].selected) {
                                        h = h.val();
                                        n && (d[n] = h);
                                        if (v) {
                                            for (u = 0; u < c.length && (d[m] = c[u], v(e, d) != h); u++);
                                        } else {
                                            d[m] = c[h];
                                        }
                                        k.push(q(e, d))
                ...
                if (m[1]) {
                    var n = m[0];
                    m = m[1];
                    var t = h.multiple, s = h.ngOptions, u = !1, x, B = y(S.createElement("option")), z = y(S.createElement("optgroup")), w = B.clone();
                    h = 0;
                    for (var v = g.children(), D = v.length; h < D; h++)if ("" === v[h].value) {
                        x = u = v.eq(h);
                        break
                    }
                    n.init(m, u, w);
    ...
    }], td = $({restrict: "E", terminal: !1});
    N.angular.bootstrap ? console.log("WARNING: Tried to load angular more than once.") : ((Ga = N.jQuery) ? (y = Ga, w(Ga.fn,
        {
            scope: Ka.scope,
        ...
        }), Ib("remove", !0, !0, !1), Ib("empty", !1, !1, !1), Ib("html", !1, !1, !0)) : y = U, Qa.element = y, ld(Qa), y(S).ready(function () {
        id(S, ic)
    }))
})(window, document);
