...
angular.module("mgcrea.ngStrap.aside", ["mgcrea.ngStrap.modal"]).provider("$aside", function () {
  ...
  return {
    restrict: "EAC", scope: !0, link: function (e, a, i) {
      ...
      }), i.bsAside && e.$watch(i.bsAside, function (t) {
        angular.isObject(t) ? angular.extend(e, t) : e.content = t
      }, !0);
      var o = n(r);
      a.on(i.trigger || "click", o.toggle), e.$on("$destroy", function () {
        o.destroy(), r = null, o = null
      })
    }
  }
}]);
